...
sections = {
  ...
  97: {
    "text":         "Vor dir steht ein Hüne von einem Kerl. Über seiner schweren Rüstung glänzt der Goldene Greif, das Wappentier Rhenus. Der gestandene Soldat schaut dich trotz etwas verschlafener Augen finster an. In der Rechten hält er ein Öllaterne, in der Linken Öllaterne und Öllaternescheide samt Gürtel. Er konnte seine komplette Ausrüstung wohl nicht mehr rechtzeitig anlegen. Laterne und Scheide legt er langsam - ohne dich aus den Augen zu lassen - neben sich auf den Boden.",
    "type":         "choice",
    "route":        "blue",
    "next_section": {
...
def update_progression(route):
    ...
    match route:
        ...
        case "white":
            progression_points += 0
        case "finish":
            progression_points = max_progression
...
def show_section(current_section):
    ...
    if section["type"] == "linear" or section["type"] == "requirement":
        print("Press Enter To See Next Section Or 'Exit' To Close ")
        choice = input(">>>")
